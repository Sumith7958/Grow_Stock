        ...
        <Grid container sx={{ p: 2, pb: 2, color: '#fff' }}>
          <Grid item xs={12}>
            <Grid container alignItems="center" justifyContent="space-between">
              <Grid item>
                <Typography variant="h4" sx={{ color: theme.palette.success.dark }}>{name}</Typography>
              </Grid>
              <Grid item>
              ...
              >
                ...
                <TableCell >
                  <Box display="flex" alignItems="center">
                    ...
                    <Typography variant="h5" sx={{ color: theme.palette.success.dark,pl:0.5}}> (+{row.change}%)</Typography> 
                  </Box>
                </TableCell>
                <TableCell >
                  <Typography variant="h4" sx={{ color: theme.palette.success.dark }}>+{row.Contribution}</Typography> 
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
